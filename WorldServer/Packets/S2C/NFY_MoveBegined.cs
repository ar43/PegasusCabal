...
{
	internal class NFY_MoveBegined : PacketS2C
	{
		UInt32 _charId, _timestamp;
		UInt16 _fromX, _fromY, _toX, _toY;

		public NFY_MoveBegined(UInt32 charId, UInt32 timestamp, UInt16 fromX, UInt16 fromY, UInt16 toX, UInt16 toY) : base((UInt16)Opcode.NFY_MOVEBEGINED)
		{
			_charId = charId;
